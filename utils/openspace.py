...
class Openspace:
    def __init__(self,number_of_tables: int, table_capacity: int) -> None:
        ...
        Args: 
            ...
            table_capacity: How many seats each table should have
        """
        self.tables = [Table(table_capacity) for n in range(number_of_tables)]      # This creates a list of Table objects, each with the specified number of seats
